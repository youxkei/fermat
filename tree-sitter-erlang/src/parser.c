...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_function_repeat1, 2, .production_id = 3),
  [90] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_repeat1, 2, .production_id = 3), SHIFT_REPEAT(42),
  [93] = {.entry = {.count = 1, .reusable = true}}, SHIFT(47),
  [95] = {.entry = {.count = 1, .reusable = true}}, SHIFT(52),
  [97] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function, 2, .production_id = 1),
  ...
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_clause, 4, .production_id = 4),
  [116] = {.entry = {.count = 1, .reusable = true}}, SHIFT(65),
  [118] = {.entry = {.count = 1, .reusable = true}}, SHIFT(62),
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_function_repeat1, 2, .production_id = 2),
  [122] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pat_argument_list, 2),
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_export_mfa, 3),
  [126] = {.entry = {.count = 1, .reusable = true}}, SHIFT(61),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_clause, 5, .production_id = 5),
  [130] = {.entry = {.count = 1, .reusable = true}}, SHIFT(56),
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_export_attribute, 6),
  ...
  [142] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module_attribute, 5),
  ...
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_export_attribute, 7),
  [162] = {.entry = {.count = 1, .reusable = true}}, SHIFT(67),
  [164] = {.entry = {.count = 1, .reusable = true}}, SHIFT(48),
  [166] = {.entry = {.count = 1, .reusable = true}}, SHIFT(29),
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_export_attribute, 8),
};
