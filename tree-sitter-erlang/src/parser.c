...
enum {
  ...
  sym_exprs = 44,
  sym_expr = 45,
  sym_equal_expr_block = 46,
  sym_equal_expr_open = 47,
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_equal_expr_block, 2),
  ...
  [114] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_equal_expr_open, 2),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_equal_expr_open, 2),
